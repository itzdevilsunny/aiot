      ...
      <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="absolute right-0 mt-1.5 w-80 rounded-xl bg-white border border-slate-200 shadow-popover py-2 z-50 animate-in fade-in-50 zoom-in-95">
              <div className="px-4 py-2 flex items-center justify-between border-b border-slate-100">
                <h4 className="text-xs font-bold text-slate-900 flex items-center gap-1.5">
                  <ShieldCheck className="w-4 h-4 text-emerald-600" /> MNB Research Operations Alerts
                </h4>
                <button 
        ...
        <div className="flex items-center gap-2 pl-1">
          ...
          <div className="hidden md:block text-left">
            ...
            <span className="text-[10px] text-slate-500 font-medium block mt-0.5">Business Operations Intern</span>
          </div>
        </div>
      </div>
    </header>
